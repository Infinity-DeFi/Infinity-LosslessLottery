...
const REWARD_LISTENER_INTERFACE_HASH = web3.utils.soliditySha3('INFDRewardListener')
...
contract('BasePool', (accounts) => {
  ...
  describe('reward()', () => {
    ...
    it('should call the reward listener if set', async () => {
    ...
    it('should gracefully handle a broken reward listener', async () => {
